    ...
    return (
        <div className="user-guide">
            ...
            <div className="user-guide-text">
                ...
                <h2>Step 2. Click on any red points on the map to display person data in the left menu panel.</h2>
                <h2>Note #1: The number of matched users will be shown once a query is complete. In some cases, the filter will match no records.</h2>
                <h2>Note #2: A small number of records are included in this demo. Try ages 37 or 81 to guarantee results.</h2>
            </div>
        </div>
    )
}
